...
run_gam(red_blood_cell_distribution_width, "Red Blood Cell Distribution Width")
...
run_gam(haemoglobin_concentration, "Haemoglobin Concentration")
...
run_gam(haematocrit_percentage, "Haematocrit Percentage")
...
run_gam(mean_corpuscular_volume, "Mean Corpuscular Volume")
...
run_gam(mean_corpuscular_haemoglobin, "Mean Corpuscular Haemoglobin")
...
run_gam(mean_corpuscular_haemoglobin_concentration, "Mean Corpuscular Haemoglobin Concentration")
...
run_gam(mean_platelet_volume, "Mean Platelet Volume")
...
run_gam(neutrophil_count, "Neutrophil Count")
...
run_gam(monocyte_count, "Monocyte Count")
...
run_gam(eosinophill_count, "Eosinophill Count")
...
run_gam(white_blood_cell_count, "White Blood Cell Count")
...
run_gam(lymphocyte_count, "Lymphocyte Count")
