...
covar <- merge(covar, principal_components, by.x="eid_69328", by.y="eid", sort = FALSE)
...
merged_phenotypes <- merge(original_linked_ids, residuals, by.x="eid_19266", by.y="eid_19266", sort=FALSE)
